...
export default function ProgressBar() {
  ...
  return (
    <View
      ...
      style={{
        opacity:
          syncProgressPercentage == 100 || syncProgressPercentage == 0 ? 0 : 1,
      }}
    >
      <View
        className="bg-blue-600 h-1.5 rounded-full dark:bg-blue-500  transition-[width] duration-1000 delay-200 ease-in-out"
